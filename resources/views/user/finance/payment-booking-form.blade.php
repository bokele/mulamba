                    ...
                    <div class="card-body">
                        ...
                        <form id="payment-form" method="post" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="tel" name="phone_number"
                                                value="{{Auth::user()->mobile_number ?? ''}}" class="form-control"
                                                id="phone_number" />
                                            <span class="invalid-feedback d-block" role="alert">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="state_or_province" name="state_or_province"
                                                placeholder="state or province" class="form-control " disabled
                                                value="{{ $address->state ?? ''}}" />
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="credit_card_name" class="form-label">Full name as displayed on
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="credit_card_name"
                                                name="credit_card_name" placeholder=""
                        ...
                        <ul class="list-group mb-3">
                            ...
                            <li class="list-group-item d-flex justify-content-between lh-sm">
                                <div>
                                    ...
                                    <small class="text-muted">{{$car_sold->shpping_city}}</small>
                                </div>
                            ...
                            <li class="list-group-item d-flex justify-content-between bg-light">
                                ...
                                <span class="text-orange font-weight-bolder">
                                    {{number_format($price/100,2) ?? ''}}</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between">
                                <span class="font-weight-bolder">Buyin at ({{$order_currency}})</span>
                                <span
                                    class="text-purple font-weight-bolder">{{number_format($propose_price/100,2) ?? ''}}</span>
                            </li>
                        </ul>
