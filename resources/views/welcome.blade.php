            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 ">
                        <div class="icon-box shadow-lg mb-5 rounded" data-aos="fade-up ">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="icon-box shadow-lg mb-5 rounded" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="icon-box shadow-lg mb-5 rounded" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="icon-box shadow-lg mb-5 rounded" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="icon-box shadow-lg mb-5 rounded" data-aos="fade-up" data-aos-delay="400">
